...
Last activity: 2026-07-08 - Uniform board filter (260708-erm): boards show active + current-sprint-dated tasks; old Done drops off board (R3-AAS 73→41), kept in Task Summary/pie. NOTE: OKF graph reworked to force-directed constellation (260708-etg, a9373d3) by a concurrent session — kept per user.
...
| 260708-etg | OKF graph reworked from compound-nesting to force-directed "constellation" (tasks free-floating, contains edges; nesting slider removed) — committed by a concurrent session; kept per user decision | 2026-07-08 | a9373d3 | [260708-etg-rework-okf-knowledge-graph-visualizer-to](./quick/260708-etg-rework-okf-knowledge-graph-visualizer-to/) |
