---
title: Aladin-01
description: "Advanced LocAl and Digital Innovation Network for Circular Garments — Digital Platform (NuoForm) development for B2B/B2B2C textile orchestration"
project: Aladin-01
type: eu-research
edit_url: "https://github.com/katty-fashion/Aladin-01/edit/main/kanban.md"
generated: 2026-03-09T05:21:10.472246
---
...
kanban
  Todo
    t3["Architecture documentation & DevOps playbook (Kubernetes, CI/CD, OAuth 2.0)"]
    t4["B2B layer — core database schema & NuoForm instance setup (T2.2)"]
    t5["B2B layer — Tech Pack & BOM backend services (T2.2)"]
    t6["B2C frontend — OAuth 2.0 multi-tenant login & registration (T2.3)"]
    t7["B2C frontend — Client Garment Configurator MVP (T2.3)"]
    t8["| Todo"]
  In-Progress
    t2["Initial platform architecture (WP2 / T2.1) — user personas & journey mapping"]
  Review
  Done
    t1["Project setup & repo bootstrap"]
```
