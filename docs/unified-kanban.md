...
generated: 2026-03-05T21:56:59.538441
---
...
kanban
  Todo
    ...
    task6[NuoForm---GTM: Documentation]@{ priority: 'Low', assigned: 'developer' }
    task9[project-template: Documentation]@{ priority: 'Low', assigned: 'developer' }
  In-Progress
    task2[Aladin-01: Initial architecture]@{ priority: 'Very High', assigned: 'tech-lead' }
    task5[NuoForm---GTM: Initial architecture]@{ priority: 'Very High', assigned: 'tech-lead' }
    task8[project-template: Initial architecture]@{ priority: 'Very High', assigned: 'tech-lead' }
  Review
  Done
    task1[Aladin-01: Project setup]@{ assigned: 'lead' }
    task4[NuoForm---GTM: Project setup]@{ assigned: 'lead' }
    task7[project-template: Project setup]@{ assigned: 'lead' }
```
