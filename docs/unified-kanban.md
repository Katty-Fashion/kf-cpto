...
generated: 2026-06-24T14:16:50.842186
---
...
<div class="kanban-board">
  <div class="kanban-col kanban-col--todo">
    <div class="kanban-col__head">Todo <span class="kanban-col__count">73</span></div>
    ...
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Collections fix + refactor (Kanban, season relations)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: BOM editor + LLM ecodesign hook (PDF export fix + stub)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Sizing Table &amp; QA Flow customizabil per tenant</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Cost Breakdown &amp; OCS clarification (Buyer approval workflow)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Tech Process refactor (aliniere BE update)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Inventory &amp; Reception refactor (types, qty packaging, UOM)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Orders refactor (Order Name, pricing, Buyer tracking portal)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Planner (Calendar/Gantt/Kanban switch) — backend nou</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Batches &amp; Assignment (Operator assignment integrat)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Operator View tablet (Timer, QR scan, defect flag, 3D viewer)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: QC Module (Inspection flow, defect logger)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Reports &amp; Cutting (camera integration, COCO export)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: DPP Module (data model, dashboard, validation) — T2.4 ALADIN</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Public DPP / GS1 Digital Link / QR (no-auth endpoint)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Auditor View (cross-tenant, elevated scope)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Made2Flow dynamic JSONB schema</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Migration testing (data + flow E2E)</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Final QA &amp; production cutover (smoke tests, monitoring)</a>
  </div>
  <div class="kanban-col kanban-col--in-progress">
    ...
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: Project setup (repo, monorepo structure, conventions)</a>
  </div>
