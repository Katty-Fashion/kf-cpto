...
generated: 2026-07-02T19:56:06.845749
---
...
<div class="kanban-board">
  <div class="kanban-col kanban-col--todo">
    <div class="kanban-col__head">Todo <span class="kanban-col__count">42</span></div>
    <a class="kanban-card" href="{{ '/projects/r3-aas/' | relative_url }}">R3-AAS: Decizie Made2Flow (demo vs integrare reală)</a>
    ...
    <a class="kanban-card" href="{{ '/projects/kf-be-platform/' | relative_url }}">kf-be-platform: [F6.S17.Data Migration Scripts]</a>
    <a class="kanban-card" href="{{ '/projects/kf-fe-platform/' | relative_url }}">kf-fe-platform: [F5.S14.Garment Configurator (T2.3)]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F4.S11.Operator View]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F5.S11.DPP Module (T2.4)]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F5.S12.Public DPP / GS1]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F5.S15.Auditor View]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F5.S16.Made2Flow Schema]</a>
    <a class="kanban-card" href="{{ '/projects/kf-platform/' | relative_url }}">kf-platform: [F6.S16.Migration Testing]</a>
  ...
  <div class="kanban-col kanban-col--in-progress">
    <div class="kanban-col__head">In Progress <span class="kanban-col__count">34</span></div>
