...
| Implement scheduling request endpoint KF → LMS | @backend | 2d | Done |
| Implement scheduler response parser | @backend | 2d | Done |
| Integrate scheduling results with planner UI | @frontend | 3d | Done |
...
| Run first scheduling tests with real production data | @tech-lead | 1d | Done |
| Debug integration issues with LMS team | @tech-lead | 1d | Done |
| Integration validation review | @tech-lead | 0.5d | Done |
| M2F - finalise & confirm assumed KF-M2F shell structure | Eduard Lazăr / M2F | 2d | Done |
| Export R3 AAS shells → move to Netcompany-hosted R3 platform | Eduard Lazăr / Netcompany | 3d | Done |
...
| Connect + test M2F V2 API from new Nuoform | Alexandru Bejenari | 5d | Done |
| Re-point all connections to Netcompany-hosted R3 go live | Mihai A. | 3d | Done |
